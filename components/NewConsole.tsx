        ...
        <div className="bg-gray-950/90 backdrop-blur-xl rounded-3xl p-6 md:p-8 space-y-6 border border-white/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-[10px] uppercase font-bold text-cyan-400 ml-2 tracking-widest">Name</label>
              <input name="name" placeholder="e.g. PlayStation 5" required className="input-gamer" />
            </div>

            <div className="flex flex-col gap-1.5">
              <label className="text-[10px] uppercase font-bold text-cyan-400 ml-2 tracking-widest">Manufacturer</label>
              <input name="manufacturer" placeholder="e.g. Sony" required className="input-gamer" />
            </div>

            <div className="flex flex-col gap-1.5 md:col-span-2">
              <label className="text-[10px] uppercase font-bold text-cyan-400 ml-2 tracking-widest">Release Date</label>
            ...
            <div className="col-span-1 md:col-span-2 space-y-3 pt-2">
              <label className="text-[10px] uppercase font-bold text-purple-400 ml-2 tracking-widest text-center block">Hardware Image</label>
              ...
              {preview && (
                <div className="mt-2 rounded-xl overflow-hidden border border-cyan-400/30 shadow-[0_0_20px_rgba(0,255,255,0.4)] transition-all animate-in fade-in zoom-in">
            ...
            <div className="flex flex-col gap-1.5 md:col-span-2">
              <label className="text-[10px] uppercase font-bold text-cyan-400 ml-2 tracking-widest">Description</label>
              <textarea name="description" placeholder="Technical specs or history..." className="input-gamer min-h-[100px]" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-white/5">
            ...
            >
              {isUploading ? "UPLOADING..." : "Save Console"}
            </button>
          </div>
        </div>
      </form>
